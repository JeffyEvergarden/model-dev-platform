...
const getList = (req: any, res: any) => {
  res.json({
    ...
    result: {
      head: ['期数', 'M1', 'M2', 'period_3', 'period_4', '1111111', '22222222', '333333'],
      data: [
        ['mob00', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%'],
        ['mob01', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%'],
        ['mob03', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%', '6.25%'],
      ],
    },
  });
};
